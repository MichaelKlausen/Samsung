# Load feature data and combine train and test to one dataset
...
# Load subject data and combine it to one dataset
...
# Find feature columns with mean and std but NOT with meanFreq
...
# Find meaningfull names for activity variable
...
# Add acitivity and subjects to full_clean dataset
...
# Create tidy dataset with mean values grouped by Subject and Activity
